...
using System.IO;                    // StreamReader, StreamWriter를 쓰기위해...
using System.Net;                   // 네트워크
using System.Net.Sockets;           // TCP 소켓

using System.Windows.Forms;   //MessageBox.Show

namespace OjwSocketFunction
{
    public class COjwSocket
    {
        ...
        public bool Send(byte[] byteData)
        {
            try
            {
                ...
                //byte[] byteSend = new byte[nLength];
                //for (int i = 0; i < nLength; i++)
                //{
                //    byteSend[i] = byteData[i];
                //}                
        ...
        //    catch
        //    {
        //        //if (IsConnect[nType]) Message(strName + "데이터를 읽는 과정에서 오류 발생");
        //    }
        //}
    }
}
