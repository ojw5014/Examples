...
namespace Step2_basic_Pose
{
    public partial class Form1 : Form
    {
        ...
        {            
            //m_CMotor.Stop();
            m_CMotor.Mpsu_ReMocon(_CH, 100, 15);
        }
        private void MoveForward()
        {
            m_CMotor.Mpsu_ReMocon(_CH, 100, 14);
        }
        private void MoveBackward()
        {
            m_CMotor.Mpsu_ReMocon(_CH, 100, 17);
        }
        private void MoveTurnLeft()
        {
            m_CMotor.Mpsu_ReMocon(_CH, 100, 13);
        }
        private void MoveTurnRight()
        {
            m_CMotor.Mpsu_ReMocon(_CH, 100, 16);
        }
        #endregion Move
        private void MoveLeft()
        {
            m_CMotor.Mpsu_ReMocon(_CH, 100, 1);
        }
        private void MoveRight()
        {
            m_CMotor.Mpsu_ReMocon(_CH, 100, 2);
        }
