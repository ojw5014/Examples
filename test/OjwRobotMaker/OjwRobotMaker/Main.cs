...
{    
    public partial class Main : Form
    {
        ...
        private void Main_Load(object sender, EventArgs e)
        {
            ...
            m_C3d.InitTools_Status(pnStatus);
            m_C3d.InitTools_Kinematics(pnKinematics);
            ...
            m_C3d.SetDrawText_ForDisplay(txtDraw);
        ...
        private void tmrDisp_Tick(object sender, EventArgs e)
        {
            ...
            int nInverseKinematics;
            if (m_C3d.GetPickingData(out nGroupA, out nGroupB, out nGroupC, out nInverseKinematics) == true)
            {
                lbPick.Text = String.Format("{0}, {1}, {2}, {3}", nGroupA, nGroupB, nGroupC, nInverseKinematics);
            }
            else
            {
                if (lbPick.Text.Length > 0) lbPick.Text = String.Empty;
            }
#endif
        }
#if _DEF_THREAD
